...
public class TeacherController {
    ...
    public String getAllTeacherBySubjectAddressSex(String subject,String address,String sex,Model model,HttpServletRequest request){
        ...
        int totals = teachers.size();//模糊查询所得的长度
