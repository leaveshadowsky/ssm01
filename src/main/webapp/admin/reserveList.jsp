...
<header class="publicHeader">
    ...
    <div class="publicHeaderR">
        <p><span>管理员: </span><span style="color: #fff21b"> ${sessionScope.admin1.userName}</span> , 欢迎您！</p>
...
<section class="publicMian ">
    ...
    <div class="right">
        ...
        <p style="font-family: cursive; font-size: large" align="center">
            当前页面${page.pageNo}
            <a href="${basePath}/reserve/getReserveByPage?currentPage=${page.firstPage}">首页</a>
            <a href="${basePath}/reserve/getReserveByPage?currentPage=${page.prePage}">上一页</a>
            <a href="${basePath}/reserve/getReserveByPage?currentPage=${page.nextPage}">下一页</a>
            <a href="${basePath}/reserve/getReserveByPage?currentPage=${page.lastPage}">尾页</a>
            共${page.pageCount}页
        </p>
