...
<section class="publicMian">
    ...
    <div class="right">
        ...
        <p align="center" style="font-family: cursive; font-size: large">
            当前页面${page.pageNo}
            <a href="${basePath}/teacher/getCurrentPage?currentPage=${page.firstPage}">首页</a>
            <a href="${basePath}/teacher/getCurrentPage?currentPage=${page.prePage}">上一页</a>
            <a href="${basePath}/teacher/getCurrentPage?currentPage=${page.nextPage}">下一页</a>
            <a href="${basePath}/teacher/getCurrentPage?currentPage=${page.lastPage}">尾页</a>
            共${page.pageCount}页
        </p>
    </div>
</section>
